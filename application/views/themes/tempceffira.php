    ...
    <head>
		...
		<?php 
			...
			if(!array_key_exists('title',$meta) || $meta['title']==''){
				echo '<title>Bengkel Mobil, Motor dan Modifikasi Indonesia - Beritabengkel.com</title>';echo "\n\t\t";
				$meta['title'] = 'Bengkel Mobil, Motor dan Modifikasi Indonesia - Beritabengkel.com';
			}else{
			...
			if(!empty($meta)){
				...
				foreach($meta as $name=>$content){
					if($name=='description' || $name == 'title' || $name=='keywords' || $name=='author'){
						if(empty($content) || $content==null){
							if($name=='title')   	  { echo '<meta name="title" content="Bengkel Mobil, Motor dan Modifikasi Indonesia - Beritabengkel.com" />';echo "\n\t\t"; }
							if($name=='keywords')	  { echo '<meta name="keywords" content="berita bengkel mobil, bengkel motor, informasi bengkel" />';echo "\n\t\t"; }
							if($name=='description')  { echo '<meta name="description" content="sumber informasi berita bengkel mobil motor modifikasi, bengkel resmi rekomendasi favorit terbaik, biaya service perawatan mesin ganti oli pelumas sparepart, daftar harga oli sparepart murah bagus terjamin, tips otomotif mobil toyota honda daihatsu suzuki nissan, tips otomotif motor honda yamaha suzuki" />';echo "\n\t\t"; }
						}else{
				...
				foreach($meta as $name=>$content){
						...
						if( (empty($content) || $content==null) && ($name=='description' || $name == 'title' || $name=='keywords' || $name=='author' || $name=='image' || $name=='image:width' || $name=='image:height' || $name=='type')){
							if($name=='title')   	  echo '<meta property="og:title" content="Bengkel Mobil, Motor dan Modifikasi Indonesia - Beritabengkel.com" />';
							if($name=='keywords')	  echo '<meta property="og:keywords" content="berita bengkel mobil, bengkel motor, informasi bengkel" />';
							if($name=='description')  echo '<meta property="og:description" content="sumber informasi berita bengkel mobil motor modifikasi, bengkel resmi rekomendasi favorit terbaik, biaya service perawatan mesin ganti oli pelumas sparepart, daftar harga oli sparepart murah bagus terjamin, tips otomotif mobil toyota honda daihatsu suzuki nissan, tips otomotif motor honda yamaha suzuki" />';
						}else{
