...
<script type="text/javascript">
    ...
    $(function () {
        contoj = $('#contoj').dataTable({
            ...
            "sAjaxSource": "<?php echo base_url(); ?>admin/preview/listpreviewdata",
            "bAutoWidth": true,
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data Admin Preview</h3>
                </div><!-- /.box-header -->
                
                <div class="box-body">
					<button class="btn btn-danger btn-flat" onclick="location.href='<?php echo site_url('admin/preview/addpreview'); ?>'">&nbsp;&nbsp;&nbsp;Tambah Preview Baru&nbsp;&nbsp;&nbsp;</button>
                  </div>
                
                <div class="box-body">
                    <table id="contoj" class="data display datatable" cellspacing="0" width="100%">
						<label class="nobold"> Cari Title DLOG <input id="beritatitle"  onkeyup="contoj.fnDraw();" name="previewtitle" type="text" class="form-control" value=""/> </label>
