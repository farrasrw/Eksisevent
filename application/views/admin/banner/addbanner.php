...
<script type="text/javascript">
    ...
    bkLib.onDomLoaded(function() {
		...
		<section class="content-header col-md-offset-2">
          <h1>
              Admin <small>Salubritas.com</small>
          </h1>
          <ol class="breadcrumb">
						  ...
						  <div class="box-body">
							...
							<div class="form-group row">
								<label class="col-sm-3 control-label " for="exampleInputEmail1">Banner Url</label>
								 <div class="col-sm-8">
								  <input type="text" class="form-control"  placeholder="ex : http://www.top1.co.id/" name="txtBannerUrl" value="<?php echo $banner_url; ?>" required>
