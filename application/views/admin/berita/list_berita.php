            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data Admin DLOG</h3>
                </div><!-- /.box-header -->
                
                <div class="box-body">
					<button class="btn btn-danger btn-flat" onclick="location.href='<?php echo site_url('admin/berita/addberita'); ?>'">&nbsp;&nbsp;&nbsp;Tambah DLOG Baru&nbsp;&nbsp;&nbsp;</button>
                  </div>
                
                <div class="box-body">
                    <table id="contoj" class="data display datatable" cellspacing="0" width="100%">
						<label class="nobold"> Cari Title DLOG <input id="beritatitle"  onkeyup="contoj.fnDraw();" name="beritatitle" type="text" class="form-control" value=""/> </label>
