    ...
    <section class="content">
      	<div class="row">
            ...
            <div class="col-md-2" id="leftCol">
					<div id="sidebar">
					<h3>Menu DLOG</h3>
					<a style="margin-bottom:5px" href="<?php echo base_url(); ?>admin/berita/index.html" class="btn btn-success btn-flat"><i class="glyphicon glyphicon-briefcase"></i>&nbsp;&nbsp; Lihat Data DLOG </a>
					<a onclick="saveberita()" style="margin-bottom:5px" href="#" class="btn bg-navy btn-flat"><i class="glyphicon glyphicon-save"></i>&nbsp;&nbsp; Save DLOG </a>
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Harap Isi Form DLOG Dengan Lengkap</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/berita/<?php echo ($viewstate=='add'?'saveaddberita':'saveeditberita');  ?>" id="formberita">
				...
				<div class="form-group">
                  <label  class="col-sm-3 control-label nobold font16">DLOG Kategori</label>
                  <div class="col-sm-5">
				...
				<div class="form-group">
                  <label  class="col-sm-3 control-label nobold font16">DLOG Direct Url</label>
                  <div class="col-sm-8">
				...
				<div class="form-group">
                  <label  class="col-sm-3 control-label nobold font16">DLOG Synopsis</label>
                  <div class="col-sm-8">
				...
				<div class="form-group">
                  <div class="col-sm-11  pull-right" style="width:95%" >
					<label  class="control-label nobold font16">DLOG Content</label>  <br>
				...
				<!--<div class="form-group">
                  <label  class="col-sm-3 control-label nobold font16">DLOG Headline</label>
                  <div class="col-sm-8">
				...
				<div class="form-group">
                  <label  class="col-sm-3 control-label nobold font16">DLOG Status</label>
                  <div class="col-sm-5">
