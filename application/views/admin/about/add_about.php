      	...
      	<div class="col-md-2" id="leftCol">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/about/<?php echo ($viewstate=='add'?'saveaddabout':'saveeditabout');  ?>" id="formabout">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="txtType"  required class="form-control">
						<option value="0" <?php echo ($about->about_type==0?'selected':''); ?>>ABOUT US</option>  
						<option value="1" <?php echo ($about->about_type==1?'selected':''); ?>>CONTACT US</option> 
					</select>
                  </div>
                </div>
              ...
              <!--<div class="box-footer">
                ...
                <a href="<?php echo base_url(); ?>admin/about/index.html" class="btn btn-default">Batal</a>
                <button onclick="savedirektori()" type="button" class="btn btn-primary pull-right col-xs-4 ">Simpan</button>
              </div>-->
